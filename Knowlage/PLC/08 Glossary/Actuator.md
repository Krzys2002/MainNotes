...
## Definition
Device that converts PLC output commands into physical action, such as a relay, valve, motor starter, or lamp.

## Short Explanation
Use this term when reading PLC documentation, lecture slides, and exam tasks.
